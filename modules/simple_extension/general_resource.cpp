...
void General_Resource::sub_res(int p_value) {
    if(current_resource - abs(p_value) < min_resource) {
...
int General_Resource::get_min_res() {
    return min_resource;
}
...
void General_Resource::set_min_res(int p_value) {
    min_resource = p_value;
}
...
void General_Resource::_bind_methods() {
    ...
    ClassDB::bind_method(D_METHOD("add_min_res", "value"), &General_Resource::add_min_res);
    ClassDB::bind_method(D_METHOD("sub_min_res", "value"), &General_Resource::sub_min_res);
    ...
    ClassDB::bind_method(D_METHOD("get_max_res"), &General_Resource::get_min_res);
    ClassDB::bind_method(D_METHOD("set_max_res", "value"), &General_Resource::set_max_res);
    ClassDB::bind_method(D_METHOD("set_min_res", "value"), &General_Resource::set_min_res);
